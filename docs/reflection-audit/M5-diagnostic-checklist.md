...
| 2996-33 | `extract<T>(r)` value extraction: `r` represents a variable or object of type `U`, the qualification conversion to `T` is permitted, and a variable is usable in constant expressions or began its lifetime in the current core constant expression. | Covered | [m5-p2996-batch10.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch10.verify.cpp) |
| 2996-34 | `extract<T>(r)` member/function extraction: `r` is a non-bit-field direct member or implicit-object member function and `T` is the corresponding permitted member-pointer type. | Covered | [m5-p2996-batch10.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch10.verify.cpp) |
| 2996-35 | `extract<T>(r)` value extraction: pointer types are similar/compatible as required, or non-pointer cv-unqualified types match. | Covered | [m5-p2996-batch10.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch10.verify.cpp) |
| 2996-36 | `can_substitute(templ, args)`: `templ` represents a template and every argument reflection represents a usable template argument. | Covered | [m5-p2996-batch10.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch10.verify.cpp) |
| 2996-37 | `substitute(templ, args)`: `can_substitute(templ, args)` is true. | Covered | [m5-p2996-batch10.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch10.verify.cpp) |
| 2996-38 | `data_member_spec(type, options)`: `dealias(type)` is an object or reference type. | Covered | [m5-p2996-batch11.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch11.verify.cpp) |
| 2996-39 | `data_member_spec`: a supplied name is a valid identifier in the required encoding and does not conflict with the generated member rules. | Covered | [m5-p2996-batch11.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch11.verify.cpp) |
| 2996-40 | `data_member_spec`: supplied `type`, `width`, `alignment`, and `no_unique_address` options satisfy their individual type/value and combination constraints. | Covered | [m5-p2996-batch11.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p2996-batch11.verify.cpp) |
...
| ID | Condition | Status | Existing coverage |
|---|---|---|---|
| 3687-01 | Splice-template-arguments are removed from C++26 and must be rejected in template-argument position. | Covered | [m5-p3617-p3687-batch6.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p3617-p3687-batch6.verify.cpp) |
| 3687-02 | `^^qualified-id` is ill-formed when lookup finds a declaration replacing a using-declarator. | Covered | [m5-p3617-p3687-batch6.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p3617-p3687-batch6.verify.cpp) |
| 3687-03 | If lookup finds multiple entity proxies, the reflection is ambiguous and ill-formed. | Covered | [m5-p3617-p3687-batch6.verify.cpp](../../libcxx/test/std/experimental/reflection/m5-p3617-p3687-batch6.verify.cpp) |
