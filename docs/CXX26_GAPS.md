...
| [~] | P3179R9 | Parallel range algorithms | Large surface (~90 algorithms), untriaged until 2026-09-05. **2026-09-16: rotate_copy/reverse_copy slice landed** (see P3709R2's row for the return-type detail); ~88 algorithms remain, most already tracked by issue #13's own comments |
