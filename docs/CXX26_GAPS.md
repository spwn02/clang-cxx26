...
| [~] | P3179R9 | Parallel range algorithms | Partial, 2026-09-16: execution-policy overloads landed for `find`, `find_if`, `find_if_not`, `count`, `count_if`, `equal`, `copy`, and `copy_n`. Remaining approximately 80 algorithms are not done; the overall paper remains open. |
