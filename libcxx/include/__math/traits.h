...
[[__nodiscard__]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isgreater(_A1 __x, _A2 __y) _NOEXCEPT {
...
template <class _A1, class _A2, __enable_if_t<is_arithmetic<_A1>::value && is_arithmetic<_A2>::value, int> = 0>
[[__nodiscard__]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isgreaterequal(_A1 __x, _A2 __y) _NOEXCEPT {
  using type = __promote_t<_A1, _A2>;
...
template <class _A1, class _A2, __enable_if_t<is_arithmetic<_A1>::value && is_arithmetic<_A2>::value, int> = 0>
[[__nodiscard__]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isless(_A1 __x, _A2 __y) _NOEXCEPT {
  using type = __promote_t<_A1, _A2>;
...
template <class _A1, class _A2, __enable_if_t<is_arithmetic<_A1>::value && is_arithmetic<_A2>::value, int> = 0>
[[__nodiscard__]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool islessequal(_A1 __x, _A2 __y) _NOEXCEPT {
  using type = __promote_t<_A1, _A2>;
...
template <class _A1, class _A2, __enable_if_t<is_arithmetic<_A1>::value && is_arithmetic<_A2>::value, int> = 0>
[[__nodiscard__]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool islessgreater(_A1 __x, _A2 __y) _NOEXCEPT {
  using type = __promote_t<_A1, _A2>;
...
template <class _A1, class _A2, __enable_if_t<is_arithmetic<_A1>::value && is_arithmetic<_A2>::value, int> = 0>
[[__nodiscard__]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isunordered(_A1 __x, _A2 __y) _NOEXCEPT {
  using type = __promote_t<_A1, _A2>;
...
[[nodiscard]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isgreater(_A1 __x, _A2 __y) noexcept {
  using type = __promote_t<_A1, _A2>;
  return __builtin_isgreater((type)__x, (type)__y);
}
...
template <class _A1, class _A2>
  requires is_arithmetic_v<_A1> && is_arithmetic_v<_A2>
[[nodiscard]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isgreaterequal(_A1 __x, _A2 __y) noexcept {
  using type = __promote_t<_A1, _A2>;
  return __builtin_isgreaterequal((type)__x, (type)__y);
}
...
template <class _A1, class _A2>
  requires is_arithmetic_v<_A1> && is_arithmetic_v<_A2>
[[nodiscard]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isless(_A1 __x, _A2 __y) noexcept {
  using type = __promote_t<_A1, _A2>;
  return __builtin_isless((type)__x, (type)__y);
}
...
template <class _A1, class _A2>
  requires is_arithmetic_v<_A1> && is_arithmetic_v<_A2>
[[nodiscard]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool islessequal(_A1 __x, _A2 __y) noexcept {
  using type = __promote_t<_A1, _A2>;
  return __builtin_islessequal((type)__x, (type)__y);
}
...
template <class _A1, class _A2>
  requires is_arithmetic_v<_A1> && is_arithmetic_v<_A2>
[[nodiscard]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool islessgreater(_A1 __x, _A2 __y) noexcept {
  using type = __promote_t<_A1, _A2>;
  return __builtin_islessgreater((type)__x, (type)__y);
}
...
template <class _A1, class _A2>
  requires is_arithmetic_v<_A1> && is_arithmetic_v<_A2>
[[nodiscard]] inline _LIBCPP_HIDE_FROM_ABI _LIBCPP_CONSTEXPR_SINCE_CXX23 bool isunordered(_A1 __x, _A2 __y) noexcept {
  using type = __promote_t<_A1, _A2>;
  return __builtin_isunordered((type)__x, (type)__y);
}
} // namespace __ucrt
