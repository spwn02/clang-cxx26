...
#  if _LIBCPP_HAS_EXPERIMENTAL_PSTL
  template <class _Ep, random_access_iterator _InIter1, sized_sentinel_for<_InIter1> _Sent1,
    ...
    requires mergeable<_InIter1, _InIter2, _OutIter, _Comp, _Proj1, _Proj2>
  _LIBCPP_HIDE_FROM_ABI set_symmetric_difference_result<_InIter1, _InIter2, _OutIter> operator()(
    ...
    _OutIter __destination = std::set_symmetric_difference(
  ...
  _LIBCPP_HIDE_FROM_ABI set_symmetric_difference_result<borrowed_iterator_t<_Range1>, borrowed_iterator_t<_Range2>, _OutIter>
