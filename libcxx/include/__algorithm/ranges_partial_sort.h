...
#  if _LIBCPP_HAS_EXPERIMENTAL_PSTL
  ...
  _LIBCPP_HIDE_FROM_ABI _Iter operator()(
    ...
    std::partial_sort(std::forward<_Ep>(__exec), __first, __middle, __end,
  ...
  _LIBCPP_HIDE_FROM_ABI borrowed_iterator_t<_Range> operator()(
      _Ep&& __exec, _Range&& __r, iterator_t<_Range> __middle, _Comp __comp = {}, _Proj __proj = {}) const {
    return (*this)(std::forward<_Ep>(__exec), ranges::begin(__r), std::move(__middle), ranges::end(__r),
