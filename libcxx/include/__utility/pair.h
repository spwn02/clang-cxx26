...
#  if _LIBCPP_STD_VER >= 23
  // P2255R2: a constructor that would bind a reference member to a temporary is defined as deleted.
  template <class _U1, class _U2>
  static _LIBCPP_HIDE_FROM_ABI constexpr bool __is_dangling() {
    return __reference_constructs_from_temporary_v<_T1, _U1> || __reference_constructs_from_temporary_v<_T2, _U2>;
  }

  template <class _U1, class _U2>
  static _LIBCPP_HIDE_FROM_ABI constexpr bool __is_pair_constructible() {
    return is_constructible<_T1, _U1>::value && is_constructible<_T2, _U2>::value && !__is_dangling<_U1, _U2>();
  }

  template <class _U1, class _U2>
  static _LIBCPP_HIDE_FROM_ABI constexpr bool __is_dangling_pair_constructible() {
    return is_constructible<_T1, _U1>::value && is_constructible<_T2, _U2>::value && __is_dangling<_U1, _U2>();
  }
#  else
  template <class _U1, class _U2>
...
#  if _LIBCPP_STD_VER >= 23
  template <class _U1 = _T1,
            class _U2 = _T2,
            __enable_if_t<__check_pair_construction<_T1, _T2>::template __is_dangling_pair_constructible<_U1&&, _U2&&>(),
                          int> = 0>
  pair(_U1&&, _U2&&) = delete;
#  endif
...
#  if _LIBCPP_STD_VER >= 23
  ...
  template <class _U1, class _U2, __enable_if_t<__check_pair_construction<_T1, _T2>::template __is_dangling_pair_constructible<_U1&, _U2&>(), int> = 0>
...
#  if _LIBCPP_STD_VER >= 23
  template <class _U1, class _U2, __enable_if_t<__check_pair_construction<_T1, _T2>::template __is_dangling_pair_constructible<_U1 const&, _U2 const&>(), int> = 0>
...
#  if _LIBCPP_STD_VER >= 23
  ...
  template <class _U1, class _U2, __enable_if_t<__check_pair_construction<_T1, _T2>::template __is_dangling_pair_constructible<const _U1&&, const _U2&&>(), int> = 0>
  pair(const pair<_U1, _U2>&&) = delete;
#  endif
...
#  if _LIBCPP_STD_VER >= 23
  template <__pair_like_no_subrange _PairLike>
    requires(is_constructible_v<first_type, decltype(std::get<0>(std::declval<_PairLike &&>()))> &&
             ...
             !__reference_constructs_from_temporary_v<first_type, decltype(std::get<0>(std::declval<_PairLike &&>()))> &&
             !__reference_constructs_from_temporary_v<second_type, decltype(std::get<1>(std::declval<_PairLike &&>()))>)
  _LIBCPP_HIDE_FROM_ABI constexpr explicit(
  ...
  template <__pair_like_no_subrange _PairLike>
    requires(is_constructible_v<first_type, decltype(std::get<0>(std::declval<_PairLike &&>()))> &&
             is_constructible_v<second_type, decltype(std::get<1>(std::declval<_PairLike &&>()))> &&
             (__reference_constructs_from_temporary_v<first_type, decltype(std::get<0>(std::declval<_PairLike &&>()))> ||
              __reference_constructs_from_temporary_v<second_type,
