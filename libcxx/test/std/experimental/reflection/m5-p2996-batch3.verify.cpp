...
// expected-note@* {{a null reflection has no type}}
...
// expected-note@* {{exception thrown here was not caught within the constant expression}}
// expected-note@* {{a null reflection has no parent}}
...
// expected-note@* {{exception thrown here was not caught within the constant expression}}
// expected-note@* {{cannot query the object of a null reflection}}
...
// expected-note@* {{exception thrown here was not caught within the constant expression}}
// expected-note@* {{cannot query the value of a null reflection}}
