  ...
  void operator()() const {
    {
      ...
      A t(T(5));
      assert(std::atomic_fetch_max_explicit(&t, T(3), std::memory_order_seq_cst) == T(5));
      assert(t == T(5));
      assert(std::atomic_fetch_max_explicit(&t, T(9), std::memory_order_seq_cst) == T(5));
      assert(t == T(9));
      ASSERT_NOEXCEPT(std::atomic_fetch_max_explicit(&t, T(0), std::memory_order_relaxed));
    }
    {
      typedef std::atomic<T> A;
      volatile A t(T(5));
