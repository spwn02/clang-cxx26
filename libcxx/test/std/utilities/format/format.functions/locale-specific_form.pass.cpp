...
void test_floating_point_scientific_lower_case() {
  ...
  // *** Basic ***
  std::locale::global(en_US);
  test(SV("1.234567e-03"), SV("{:.6Le}"), F(1.234567e-3L));
  test(SV("1.234567e-02"), SV("{:.6Le}"), F(1.234567e-2L));
  test(SV("1.234567e-01"), SV("{:.6Le}"), F(1.234567e-1L));
  test(SV("1.234567e+00"), SV("{:.6Le}"), F(1.234567e0L));
  test(SV("1.234567e+01"), SV("{:.6Le}"), F(1.234567e1L));
  test(SV("1.234567e+02"), SV("{:.6Le}"), F(1.234567e2L));
  test(SV("1.234567e+03"), SV("{:.6Le}"), F(1.234567e3L));
  ...
  test(SV("1.234567e-03"), en_US, SV("{:.6Le}"), F(1.234567e-3L));
  test(SV("1.234567e-02"), en_US, SV("{:.6Le}"), F(1.234567e-2L));
  test(SV("1.234567e-01"), en_US, SV("{:.6Le}"), F(1.234567e-1L));
  test(SV("1.234567e+00"), en_US, SV("{:.6Le}"), F(1.234567e0L));
  test(SV("1.234567e+01"), en_US, SV("{:.6Le}"), F(1.234567e1L));
  test(SV("1.234567e+02"), en_US, SV("{:.6Le}"), F(1.234567e2L));
  test(SV("1.234567e+03"), en_US, SV("{:.6Le}"), F(1.234567e3L));
  ...
  std::locale::global(en_US);
  test(SV("1#234567e-03"), loc, SV("{:.6Le}"), F(1.234567e-3L));
  test(SV("1#234567e-02"), loc, SV("{:.6Le}"), F(1.234567e-2L));
  test(SV("1#234567e-01"), loc, SV("{:.6Le}"), F(1.234567e-1L));
  test(SV("1#234567e+00"), loc, SV("{:.6Le}"), F(1.234567e0L));
  test(SV("1#234567e+01"), loc, SV("{:.6Le}"), F(1.234567e1L));
  test(SV("1#234567e+02"), loc, SV("{:.6Le}"), F(1.234567e2L));
  test(SV("1#234567e+03"), loc, SV("{:.6Le}"), F(1.234567e3L));
  ...
  // *** Fill, align, zero padding ***
  std::locale::global(en_US);
  test(SV("1.234567e+03$$$"), SV("{:$<15.6Le}"), F(1.234567e3L));
  test(SV("$$$1.234567e+03"), SV("{:$>15.6Le}"), F(1.234567e3L));
  test(SV("$1.234567e+03$$"), SV("{:$^15.6Le}"), F(1.234567e3L));
  test(SV("0001.234567e+03"), SV("{:015.6Le}"), F(1.234567e3L));
  test(SV("-1.234567e+03$$$"), SV("{:$<16.6Le}"), F(-1.234567e3L));
  test(SV("$$$-1.234567e+03"), SV("{:$>16.6Le}"), F(-1.234567e3L));
  test(SV("$-1.234567e+03$$"), SV("{:$^16.6Le}"), F(-1.234567e3L));
  test(SV("-0001.234567e+03"), SV("{:016.6Le}"), F(-1.234567e3L));
  ...
  test(SV("1.234567e+03$$$"), en_US, SV("{:$<15.6Le}"), F(1.234567e3L));
  test(SV("$$$1.234567e+03"), en_US, SV("{:$>15.6Le}"), F(1.234567e3L));
  test(SV("$1.234567e+03$$"), en_US, SV("{:$^15.6Le}"), F(1.234567e3L));
  test(SV("0001.234567e+03"), en_US, SV("{:015.6Le}"), F(1.234567e3L));
  test(SV("-1.234567e+03$$$"), en_US, SV("{:$<16.6Le}"), F(-1.234567e3L));
  test(SV("$$$-1.234567e+03"), en_US, SV("{:$>16.6Le}"), F(-1.234567e3L));
  test(SV("$-1.234567e+03$$"), en_US, SV("{:$^16.6Le}"), F(-1.234567e3L));
  test(SV("-0001.234567e+03"), en_US, SV("{:016.6Le}"), F(-1.234567e3L));

  std::locale::global(en_US);
  test(SV("1#234567e+03$$$"), loc, SV("{:$<15.6Le}"), F(1.234567e3L));
  test(SV("$$$1#234567e+03"), loc, SV("{:$>15.6Le}"), F(1.234567e3L));
  test(SV("$1#234567e+03$$"), loc, SV("{:$^15.6Le}"), F(1.234567e3L));
  test(SV("0001#234567e+03"), loc, SV("{:015.6Le}"), F(1.234567e3L));
  test(SV("-1#234567e+03$$$"), loc, SV("{:$<16.6Le}"), F(-1.234567e3L));
  test(SV("$$$-1#234567e+03"), loc, SV("{:$>16.6Le}"), F(-1.234567e3L));
  test(SV("$-1#234567e+03$$"), loc, SV("{:$^16.6Le}"), F(-1.234567e3L));
  test(SV("-0001#234567e+03"), loc, SV("{:016.6Le}"), F(-1.234567e3L));
}
...
void test_floating_point_fixed_lower_case() {
  ...
  // *** Basic ***
  std::locale::global(en_US);
  test(SV("0.000001"), SV("{:.6Lf}"), F(1.234567e-6L));
  test(SV("0.000012"), SV("{:.6Lf}"), F(1.234567e-5L));
  test(SV("0.000123"), SV("{:.6Lf}"), F(1.234567e-4L));
  test(SV("0.001235"), SV("{:.6Lf}"), F(1.234567e-3L));
  test(SV("0.012346"), SV("{:.6Lf}"), F(1.234567e-2L));
  test(SV("0.123457"), SV("{:.6Lf}"), F(1.234567e-1L));
  test(SV("1.234567"), SV("{:.6Lf}"), F(1.234567e0L));
  test(SV("12.345670"), SV("{:.6Lf}"), F(1.234567e1L));
  if constexpr (sizeof(F) > sizeof(float)) {
    test(SV("123.456700"), SV("{:.6Lf}"), F(1.234567e2L));
    test(SV("1,234.567000"), SV("{:.6Lf}"), F(1.234567e3L));
    test(SV("12,345.670000"), SV("{:.6Lf}"), F(1.234567e4L));
    test(SV("123,456.700000"), SV("{:.6Lf}"), F(1.234567e5L));
  ...
  test(SV("0#123457"), SV("{:.6Lf}"), F(1.234567e-1L));
  test(SV("1#234567"), SV("{:.6Lf}"), F(1.234567e0L));
  test(SV("1_2#345670"), SV("{:.6Lf}"), F(1.234567e1L));
  if constexpr (sizeof(F) > sizeof(float)) {
    test(SV("12_3#456700"), SV("{:.6Lf}"), F(1.234567e2L));
    test(SV("1_23_4#567000"), SV("{:.6Lf}"), F(1.234567e3L));
    test(SV("12_34_5#670000"), SV("{:.6Lf}"), F(1.234567e4L));
    test(SV("123_45_6#700000"), SV("{:.6Lf}"), F(1.234567e5L));
  ...
  test(SV("0.000001"), en_US, SV("{:.6Lf}"), F(1.234567e-6L));
  test(SV("0.000012"), en_US, SV("{:.6Lf}"), F(1.234567e-5L));
  test(SV("0.000123"), en_US, SV("{:.6Lf}"), F(1.234567e-4L));
  test(SV("0.001235"), en_US, SV("{:.6Lf}"), F(1.234567e-3L));
  test(SV("0.012346"), en_US, SV("{:.6Lf}"), F(1.234567e-2L));
  test(SV("0.123457"), en_US, SV("{:.6Lf}"), F(1.234567e-1L));
  test(SV("1.234567"), en_US, SV("{:.6Lf}"), F(1.234567e0L));
  test(SV("12.345670"), en_US, SV("{:.6Lf}"), F(1.234567e1L));
  if constexpr (sizeof(F) > sizeof(float)) {
    test(SV("123.456700"), en_US, SV("{:.6Lf}"), F(1.234567e2L));
    test(SV("1,234.567000"), en_US, SV("{:.6Lf}"), F(1.234567e3L));
    test(SV("12,345.670000"), en_US, SV("{:.6Lf}"), F(1.234567e4L));
    test(SV("123,456.700000"), en_US, SV("{:.6Lf}"), F(1.234567e5L));
  ...
  std::locale::global(en_US);
  test(SV("0#000001"), loc, SV("{:.6Lf}"), F(1.234567e-6L));
  test(SV("0#000012"), loc, SV("{:.6Lf}"), F(1.234567e-5L));
  test(SV("0#000123"), loc, SV("{:.6Lf}"), F(1.234567e-4L));
  test(SV("0#001235"), loc, SV("{:.6Lf}"), F(1.234567e-3L));
  test(SV("0#012346"), loc, SV("{:.6Lf}"), F(1.234567e-2L));
  test(SV("0#123457"), loc, SV("{:.6Lf}"), F(1.234567e-1L));
  test(SV("1#234567"), loc, SV("{:.6Lf}"), F(1.234567e0L));
  test(SV("1_2#345670"), loc, SV("{:.6Lf}"), F(1.234567e1L));
  if constexpr (sizeof(F) > sizeof(float)) {
    test(SV("12_3#456700"), loc, SV("{:.6Lf}"), F(1.234567e2L));
    test(SV("1_23_4#567000"), loc, SV("{:.6Lf}"), F(1.234567e3L));
    test(SV("12_34_5#670000"), loc, SV("{:.6Lf}"), F(1.234567e4L));
    test(SV("123_45_6#700000"), loc, SV("{:.6Lf}"), F(1.234567e5L));
  ...
  if constexpr (sizeof(F) > sizeof(float)) {
    std::locale::global(en_US);
    test(SV("1,234.567000$$$"), SV("{:$<15.6Lf}"), F(1.234567e3L));
    test(SV("$$$1,234.567000"), SV("{:$>15.6Lf}"), F(1.234567e3L));
    test(SV("$1,234.567000$$"), SV("{:$^15.6Lf}"), F(1.234567e3L));
    test(SV("0001,234.567000"), SV("{:015.6Lf}"), F(1.234567e3L));
    test(SV("-1,234.567000$$$"), SV("{:$<16.6Lf}"), F(-1.234567e3L));
    test(SV("$$$-1,234.567000"), SV("{:$>16.6Lf}"), F(-1.234567e3L));
    test(SV("$-1,234.567000$$"), SV("{:$^16.6Lf}"), F(-1.234567e3L));
    test(SV("-0001,234.567000"), SV("{:016.6Lf}"), F(-1.234567e3L));

    std::locale::global(loc);
    test(SV("1_23_4#567000$$$"), SV("{:$<16.6Lf}"), F(1.234567e3L));
    test(SV("$$$1_23_4#567000"), SV("{:$>16.6Lf}"), F(1.234567e3L));
    test(SV("$1_23_4#567000$$"), SV("{:$^16.6Lf}"), F(1.234567e3L));
    test(SV("0001_23_4#567000"), SV("{:016.6Lf}"), F(1.234567e3L));
    test(SV("-1_23_4#567000$$$"), SV("{:$<17.6Lf}"), F(-1.234567e3L));
    test(SV("$$$-1_23_4#567000"), SV("{:$>17.6Lf}"), F(-1.234567e3L));
    test(SV("$-1_23_4#567000$$"), SV("{:$^17.6Lf}"), F(-1.234567e3L));
    test(SV("-0001_23_4#567000"), SV("{:017.6Lf}"), F(-1.234567e3L));

    test(SV("1,234.567000$$$"), en_US, SV("{:$<15.6Lf}"), F(1.234567e3L));
    test(SV("$$$1,234.567000"), en_US, SV("{:$>15.6Lf}"), F(1.234567e3L));
    test(SV("$1,234.567000$$"), en_US, SV("{:$^15.6Lf}"), F(1.234567e3L));
    test(SV("0001,234.567000"), en_US, SV("{:015.6Lf}"), F(1.234567e3L));
    test(SV("-1,234.567000$$$"), en_US, SV("{:$<16.6Lf}"), F(-1.234567e3L));
    test(SV("$$$-1,234.567000"), en_US, SV("{:$>16.6Lf}"), F(-1.234567e3L));
    test(SV("$-1,234.567000$$"), en_US, SV("{:$^16.6Lf}"), F(-1.234567e3L));
    test(SV("-0001,234.567000"), en_US, SV("{:016.6Lf}"), F(-1.234567e3L));

    std::locale::global(en_US);
    test(SV("1_23_4#567000$$$"), loc, SV("{:$<16.6Lf}"), F(1.234567e3L));
    test(SV("$$$1_23_4#567000"), loc, SV("{:$>16.6Lf}"), F(1.234567e3L));
    test(SV("$1_23_4#567000$$"), loc, SV("{:$^16.6Lf}"), F(1.234567e3L));
    test(SV("0001_23_4#567000"), loc, SV("{:016.6Lf}"), F(1.234567e3L));
    test(SV("-1_23_4#567000$$$"), loc, SV("{:$<17.6Lf}"), F(-1.234567e3L));
    test(SV("$$$-1_23_4#567000"), loc, SV("{:$>17.6Lf}"), F(-1.234567e3L));
    test(SV("$-1_23_4#567000$$"), loc, SV("{:$^17.6Lf}"), F(-1.234567e3L));
    test(SV("-0001_23_4#567000"), loc, SV("{:017.6Lf}"), F(-1.234567e3L));
  }
}
...
void test_floating_point_general_lower_case() {
  ...
  // *** Basic ***
  std::locale::global(en_US);
  test(SV("1.23457e-06"), SV("{:.6Lg}"), F(1.234567e-6L));
  test(SV("1.23457e-05"), SV("{:.6Lg}"), F(1.234567e-5L));
  test(SV("0.000123457"), SV("{:.6Lg}"), F(1.234567e-4L));
  test(SV("0.00123457"), SV("{:.6Lg}"), F(1.234567e-3L));
  test(SV("0.0123457"), SV("{:.6Lg}"), F(1.234567e-2L));
  test(SV("0.123457"), SV("{:.6Lg}"), F(1.234567e-1L));
  test(SV("1.23457"), SV("{:.6Lg}"), F(1.234567e0L));
  test(SV("12.3457"), SV("{:.6Lg}"), F(1.234567e1L));
  test(SV("123.457"), SV("{:.6Lg}"), F(1.234567e2L));
  test(SV("1,234.57"), SV("{:.6Lg}"), F(1.234567e3L));
  test(SV("12,345.7"), SV("{:.6Lg}"), F(1.234567e4L));
  test(SV("123,457"), SV("{:.6Lg}"), F(1.234567e5L));
  ...
  test(SV("0#123457"), SV("{:.6Lg}"), F(1.234567e-1L));
  test(SV("1#23457"), SV("{:.6Lg}"), F(1.234567e0L));
  test(SV("1_2#3457"), SV("{:.6Lg}"), F(1.234567e1L));
  test(SV("12_3#457"), SV("{:.6Lg}"), F(1.234567e2L));
  test(SV("1_23_4#57"), SV("{:.6Lg}"), F(1.234567e3L));
  test(SV("12_34_5#7"), SV("{:.6Lg}"), F(1.234567e4L));
  test(SV("123_45_7"), SV("{:.6Lg}"), F(1.234567e5L));
  test(SV("1#23457e+06"), SV("{:.6Lg}"), F(1.234567e6));
  test(SV("1#23457e+07"), SV("{:.6Lg}"), F(1.234567e7));
  test(SV("-1#23457e-06"), SV("{:.6Lg}"), F(-1.234567e-6L));
  test(SV("-1#23457e-05"), SV("{:.6Lg}"), F(-1.234567e-5L));
  ...
  test(SV("1.23457e-06"), en_US, SV("{:.6Lg}"), F(1.234567e-6L));
  test(SV("1.23457e-05"), en_US, SV("{:.6Lg}"), F(1.234567e-5L));
  test(SV("0.000123457"), en_US, SV("{:.6Lg}"), F(1.234567e-4L));
  test(SV("0.00123457"), en_US, SV("{:.6Lg}"), F(1.234567e-3L));
  test(SV("0.0123457"), en_US, SV("{:.6Lg}"), F(1.234567e-2L));
  test(SV("0.123457"), en_US, SV("{:.6Lg}"), F(1.234567e-1L));
  test(SV("1.23457"), en_US, SV("{:.6Lg}"), F(1.234567e0L));
  test(SV("12.3457"), en_US, SV("{:.6Lg}"), F(1.234567e1L));
  test(SV("123.457"), en_US, SV("{:.6Lg}"), F(1.234567e2L));
  test(SV("1,234.57"), en_US, SV("{:.6Lg}"), F(1.234567e3L));
  test(SV("12,345.7"), en_US, SV("{:.6Lg}"), F(1.234567e4L));
  test(SV("123,457"), en_US, SV("{:.6Lg}"), F(1.234567e5L));
  ...
  std::locale::global(en_US);
  test(SV("1#23457e-06"), loc, SV("{:.6Lg}"), F(1.234567e-6L));
  test(SV("1#23457e-05"), loc, SV("{:.6Lg}"), F(1.234567e-5L));
  test(SV("0#000123457"), loc, SV("{:.6Lg}"), F(1.234567e-4L));
  test(SV("0#00123457"), loc, SV("{:.6Lg}"), F(1.234567e-3L));
  test(SV("0#0123457"), loc, SV("{:.6Lg}"), F(1.234567e-2L));
  test(SV("0#123457"), loc, SV("{:.6Lg}"), F(1.234567e-1L));
  test(SV("1#23457"), loc, SV("{:.6Lg}"), F(1.234567e0L));
  test(SV("1_2#3457"), loc, SV("{:.6Lg}"), F(1.234567e1L));
  test(SV("12_3#457"), loc, SV("{:.6Lg}"), F(1.234567e2L));
  test(SV("1_23_4#57"), loc, SV("{:.6Lg}"), F(1.234567e3L));
  test(SV("12_34_5#7"), loc, SV("{:.6Lg}"), F(1.234567e4L));
  test(SV("123_45_7"), loc, SV("{:.6Lg}"), F(1.234567e5L));
  ...
  // *** Fill, align, zero padding ***
  std::locale::global(en_US);
  test(SV("1,234.57$$$"), SV("{:$<11.6Lg}"), F(1.234567e3L));
  test(SV("$$$1,234.57"), SV("{:$>11.6Lg}"), F(1.234567e3L));
  test(SV("$1,234.57$$"), SV("{:$^11.6Lg}"), F(1.234567e3L));
  test(SV("0001,234.57"), SV("{:011.6Lg}"), F(1.234567e3L));
  test(SV("-1,234.57$$$"), SV("{:$<12.6Lg}"), F(-1.234567e3L));
  test(SV("$$$-1,234.57"), SV("{:$>12.6Lg}"), F(-1.234567e3L));
  test(SV("$-1,234.57$$"), SV("{:$^12.6Lg}"), F(-1.234567e3L));
  test(SV("-0001,234.57"), SV("{:012.6Lg}"), F(-1.234567e3L));

  std::locale::global(loc);
  test(SV("1_23_4#57$$$"), SV("{:$<12.6Lg}"), F(1.234567e3L));
  test(SV("$$$1_23_4#57"), SV("{:$>12.6Lg}"), F(1.234567e3L));
  test(SV("$1_23_4#57$$"), SV("{:$^12.6Lg}"), F(1.234567e3L));
  test(SV("0001_23_4#57"), SV("{:012.6Lg}"), F(1.234567e3L));
  test(SV("-1_23_4#57$$$"), SV("{:$<13.6Lg}"), F(-1.234567e3L));
  test(SV("$$$-1_23_4#57"), SV("{:$>13.6Lg}"), F(-1.234567e3L));
  test(SV("$-1_23_4#57$$"), SV("{:$^13.6Lg}"), F(-1.234567e3L));
  test(SV("-0001_23_4#57"), SV("{:013.6Lg}"), F(-1.234567e3L));

  test(SV("1,234.57$$$"), en_US, SV("{:$<11.6Lg}"), F(1.234567e3L));
  test(SV("$$$1,234.57"), en_US, SV("{:$>11.6Lg}"), F(1.234567e3L));
  test(SV("$1,234.57$$"), en_US, SV("{:$^11.6Lg}"), F(1.234567e3L));
  test(SV("0001,234.57"), en_US, SV("{:011.6Lg}"), F(1.234567e3L));
  test(SV("-1,234.57$$$"), en_US, SV("{:$<12.6Lg}"), F(-1.234567e3L));
  test(SV("$$$-1,234.57"), en_US, SV("{:$>12.6Lg}"), F(-1.234567e3L));
  test(SV("$-1,234.57$$"), en_US, SV("{:$^12.6Lg}"), F(-1.234567e3L));
  test(SV("-0001,234.57"), en_US, SV("{:012.6Lg}"), F(-1.234567e3L));

  std::locale::global(en_US);
  test(SV("1_23_4#57$$$"), loc, SV("{:$<12.6Lg}"), F(1.234567e3L));
  test(SV("$$$1_23_4#57"), loc, SV("{:$>12.6Lg}"), F(1.234567e3L));
  test(SV("$1_23_4#57$$"), loc, SV("{:$^12.6Lg}"), F(1.234567e3L));
  test(SV("0001_23_4#57"), loc, SV("{:012.6Lg}"), F(1.234567e3L));
  test(SV("-1_23_4#57$$$"), loc, SV("{:$<13.6Lg}"), F(-1.234567e3L));
  test(SV("$$$-1_23_4#57"), loc, SV("{:$>13.6Lg}"), F(-1.234567e3L));
  test(SV("$-1_23_4#57$$"), loc, SV("{:$^13.6Lg}"), F(-1.234567e3L));
  test(SV("-0001_23_4#57"), loc, SV("{:013.6Lg}"), F(-1.234567e3L));
}
...
void test_floating_point_default() {
  ...
  // *** Basic ***
  std::locale::global(en_US);
  test(SV("1.234567e-06"), SV("{:L}"), F(1.234567e-6L));
  test(SV("1.234567e-05"), SV("{:L}"), F(1.234567e-5L));
  test(SV("0.0001234567"), SV("{:L}"), F(1.234567e-4L));
  test(SV("0.001234567"), SV("{:L}"), F(1.234567e-3L));
  test(SV("0.01234567"), SV("{:L}"), F(1.234567e-2L));
  test(SV("0.1234567"), SV("{:L}"), F(1.234567e-1L));
  test(SV("1.234567"), SV("{:L}"), F(1.234567e0L));
  test(SV("12.34567"), SV("{:L}"), F(1.234567e1L));
  test(SV("123.4567"), SV("{:L}"), F(1.234567e2L));
  test(SV("1,234.567"), SV("{:L}"), F(1.234567e3L));
  test(SV("12,345.67"), SV("{:L}"), F(1.234567e4L));
  test(SV("123,456.7"), SV("{:L}"), F(1.234567e5L));
  ...
  test(SV("0#1234567"), SV("{:L}"), F(1.234567e-1L));
  test(SV("1#234567"), SV("{:L}"), F(1.234567e0L));
  test(SV("1_2#34567"), SV("{:L}"), F(1.234567e1L));
  test(SV("12_3#4567"), SV("{:L}"), F(1.234567e2L));
  test(SV("1_23_4#567"), SV("{:L}"), F(1.234567e3L));
  test(SV("12_34_5#67"), SV("{:L}"), F(1.234567e4L));
  test(SV("123_45_6#7"), SV("{:L}"), F(1.234567e5L));
  ...
  test(SV("1.234567e-06"), en_US, SV("{:L}"), F(1.234567e-6L));
  test(SV("1.234567e-05"), en_US, SV("{:L}"), F(1.234567e-5L));
  test(SV("0.0001234567"), en_US, SV("{:L}"), F(1.234567e-4L));
  test(SV("0.001234567"), en_US, SV("{:L}"), F(1.234567e-3L));
  test(SV("0.01234567"), en_US, SV("{:L}"), F(1.234567e-2L));
  test(SV("0.1234567"), en_US, SV("{:L}"), F(1.234567e-1L));
  test(SV("1.234567"), en_US, SV("{:L}"), F(1.234567e0L));
  test(SV("12.34567"), en_US, SV("{:L}"), F(1.234567e1L));
  test(SV("123.4567"), en_US, SV("{:L}"), F(1.234567e2L));
  test(SV("1,234.567"), en_US, SV("{:L}"), F(1.234567e3L));
  test(SV("12,345.67"), en_US, SV("{:L}"), F(1.234567e4L));
  test(SV("123,456.7"), en_US, SV("{:L}"), F(1.234567e5L));
  ...
  std::locale::global(en_US);
  test(SV("1#234567e-06"), loc, SV("{:L}"), F(1.234567e-6L));
  test(SV("1#234567e-05"), loc, SV("{:L}"), F(1.234567e-5L));
  test(SV("0#0001234567"), loc, SV("{:L}"), F(1.234567e-4L));
  test(SV("0#001234567"), loc, SV("{:L}"), F(1.234567e-3L));
  test(SV("0#01234567"), loc, SV("{:L}"), F(1.234567e-2L));
  test(SV("0#1234567"), loc, SV("{:L}"), F(1.234567e-1L));
  test(SV("1#234567"), loc, SV("{:L}"), F(1.234567e0L));
  test(SV("1_2#34567"), loc, SV("{:L}"), F(1.234567e1L));
  test(SV("12_3#4567"), loc, SV("{:L}"), F(1.234567e2L));
  test(SV("1_23_4#567"), loc, SV("{:L}"), F(1.234567e3L));
  test(SV("12_34_5#67"), loc, SV("{:L}"), F(1.234567e4L));
  test(SV("123_45_6#7"), loc, SV("{:L}"), F(1.234567e5L));
  ...
  // *** Fill, align, zero padding ***
  std::locale::global(en_US);
  test(SV("1,234.567$$$"), SV("{:$<12L}"), F(1.234567e3L));
  test(SV("$$$1,234.567"), SV("{:$>12L}"), F(1.234567e3L));
  test(SV("$1,234.567$$"), SV("{:$^12L}"), F(1.234567e3L));
  test(SV("0001,234.567"), SV("{:012L}"), F(1.234567e3L));
  test(SV("-1,234.567$$$"), SV("{:$<13L}"), F(-1.234567e3L));
  test(SV("$$$-1,234.567"), SV("{:$>13L}"), F(-1.234567e3L));
  test(SV("$-1,234.567$$"), SV("{:$^13L}"), F(-1.234567e3L));
  test(SV("-0001,234.567"), SV("{:013L}"), F(-1.234567e3L));

  std::locale::global(loc);
  test(SV("1_23_4#567$$$"), SV("{:$<13L}"), F(1.234567e3L));
  test(SV("$$$1_23_4#567"), SV("{:$>13L}"), F(1.234567e3L));
  test(SV("$1_23_4#567$$"), SV("{:$^13L}"), F(1.234567e3L));
  test(SV("0001_23_4#567"), SV("{:013L}"), F(1.234567e3L));
  test(SV("-1_23_4#567$$$"), SV("{:$<14L}"), F(-1.234567e3L));
  test(SV("$$$-1_23_4#567"), SV("{:$>14L}"), F(-1.234567e3L));
  test(SV("$-1_23_4#567$$"), SV("{:$^14L}"), F(-1.234567e3L));
  test(SV("-0001_23_4#567"), SV("{:014L}"), F(-1.234567e3L));

  test(SV("1,234.567$$$"), en_US, SV("{:$<12L}"), F(1.234567e3L));
  test(SV("$$$1,234.567"), en_US, SV("{:$>12L}"), F(1.234567e3L));
  test(SV("$1,234.567$$"), en_US, SV("{:$^12L}"), F(1.234567e3L));
  test(SV("0001,234.567"), en_US, SV("{:012L}"), F(1.234567e3L));
  test(SV("-1,234.567$$$"), en_US, SV("{:$<13L}"), F(-1.234567e3L));
  test(SV("$$$-1,234.567"), en_US, SV("{:$>13L}"), F(-1.234567e3L));
  test(SV("$-1,234.567$$"), en_US, SV("{:$^13L}"), F(-1.234567e3L));
  test(SV("-0001,234.567"), en_US, SV("{:013L}"), F(-1.234567e3L));

  std::locale::global(en_US);
  test(SV("1_23_4#567$$$"), loc, SV("{:$<13L}"), F(1.234567e3L));
  test(SV("$$$1_23_4#567"), loc, SV("{:$>13L}"), F(1.234567e3L));
  test(SV("$1_23_4#567$$"), loc, SV("{:$^13L}"), F(1.234567e3L));
  test(SV("0001_23_4#567"), loc, SV("{:013L}"), F(1.234567e3L));
  test(SV("-1_23_4#567$$$"), loc, SV("{:$<14L}"), F(-1.234567e3L));
  test(SV("$$$-1_23_4#567"), loc, SV("{:$>14L}"), F(-1.234567e3L));
  test(SV("$-1_23_4#567$$"), loc, SV("{:$^14L}"), F(-1.234567e3L));
  test(SV("-0001_23_4#567"), loc, SV("{:014L}"), F(-1.234567e3L));
}
...
void test_floating_point_default_precision() {
  ...
  // *** Basic ***
  std::locale::global(en_US);
  test(SV("1.23457e-06"), SV("{:.6L}"), F(1.234567e-6L));
  test(SV("1.23457e-05"), SV("{:.6L}"), F(1.234567e-5L));
  test(SV("0.000123457"), SV("{:.6L}"), F(1.234567e-4L));
  test(SV("0.00123457"), SV("{:.6L}"), F(1.234567e-3L));
  test(SV("0.0123457"), SV("{:.6L}"), F(1.234567e-2L));
  test(SV("0.123457"), SV("{:.6L}"), F(1.234567e-1L));
  test(SV("1.23457"), SV("{:.6L}"), F(1.234567e0L));
  test(SV("12.3457"), SV("{:.6L}"), F(1.234567e1L));
  test(SV("123.457"), SV("{:.6L}"), F(1.234567e2L));
  test(SV("1,234.57"), SV("{:.6L}"), F(1.234567e3L));
  test(SV("12,345.7"), SV("{:.6L}"), F(1.234567e4L));
  test(SV("123,457"), SV("{:.6L}"), F(1.234567e5L));
  ...
  test(SV("0#123457"), SV("{:.6L}"), F(1.234567e-1L));
  test(SV("1#23457"), SV("{:.6L}"), F(1.234567e0L));
  test(SV("1_2#3457"), SV("{:.6L}"), F(1.234567e1L));
  test(SV("12_3#457"), SV("{:.6L}"), F(1.234567e2L));
  test(SV("1_23_4#57"), SV("{:.6L}"), F(1.234567e3L));
  test(SV("12_34_5#7"), SV("{:.6L}"), F(1.234567e4L));
  test(SV("123_45_7"), SV("{:.6L}"), F(1.234567e5L));
  test(SV("1#23457e+06"), SV("{:.6L}"), F(1.234567e6));
  test(SV("1#23457e+07"), SV("{:.6L}"), F(1.234567e7));
  test(SV("-1#23457e-06"), SV("{:.6L}"), F(-1.234567e-6L));
  test(SV("-1#23457e-05"), SV("{:.6L}"), F(-1.234567e-5L));
  ...
  test(SV("1.23457e-06"), en_US, SV("{:.6L}"), F(1.234567e-6L));
  test(SV("1.23457e-05"), en_US, SV("{:.6L}"), F(1.234567e-5L));
  test(SV("0.000123457"), en_US, SV("{:.6L}"), F(1.234567e-4L));
  test(SV("0.00123457"), en_US, SV("{:.6L}"), F(1.234567e-3L));
  test(SV("0.0123457"), en_US, SV("{:.6L}"), F(1.234567e-2L));
  test(SV("0.123457"), en_US, SV("{:.6L}"), F(1.234567e-1L));
  test(SV("1.23457"), en_US, SV("{:.6L}"), F(1.234567e0L));
  test(SV("12.3457"), en_US, SV("{:.6L}"), F(1.234567e1L));
  test(SV("123.457"), en_US, SV("{:.6L}"), F(1.234567e2L));
  test(SV("1,234.57"), en_US, SV("{:.6L}"), F(1.234567e3L));
  test(SV("12,345.7"), en_US, SV("{:.6L}"), F(1.234567e4L));
  test(SV("123,457"), en_US, SV("{:.6L}"), F(1.234567e5L));
  ...
  std::locale::global(en_US);
  test(SV("1#23457e-06"), loc, SV("{:.6L}"), F(1.234567e-6L));
  test(SV("1#23457e-05"), loc, SV("{:.6L}"), F(1.234567e-5L));
  test(SV("0#000123457"), loc, SV("{:.6L}"), F(1.234567e-4L));
  test(SV("0#00123457"), loc, SV("{:.6L}"), F(1.234567e-3L));
  test(SV("0#0123457"), loc, SV("{:.6L}"), F(1.234567e-2L));
  test(SV("0#123457"), loc, SV("{:.6L}"), F(1.234567e-1L));
  test(SV("1#23457"), loc, SV("{:.6L}"), F(1.234567e0L));
  test(SV("1_2#3457"), loc, SV("{:.6L}"), F(1.234567e1L));
  test(SV("12_3#457"), loc, SV("{:.6L}"), F(1.234567e2L));
  test(SV("1_23_4#57"), loc, SV("{:.6L}"), F(1.234567e3L));
  test(SV("12_34_5#7"), loc, SV("{:.6L}"), F(1.234567e4L));
  test(SV("123_45_7"), loc, SV("{:.6L}"), F(1.234567e5L));
  ...
  // *** Fill, align, zero padding ***
  std::locale::global(en_US);
  test(SV("1,234.57$$$"), SV("{:$<11.6L}"), F(1.234567e3L));
  test(SV("$$$1,234.57"), SV("{:$>11.6L}"), F(1.234567e3L));
  test(SV("$1,234.57$$"), SV("{:$^11.6L}"), F(1.234567e3L));
  test(SV("0001,234.57"), SV("{:011.6L}"), F(1.234567e3L));
  test(SV("-1,234.57$$$"), SV("{:$<12.6L}"), F(-1.234567e3L));
  test(SV("$$$-1,234.57"), SV("{:$>12.6L}"), F(-1.234567e3L));
  test(SV("$-1,234.57$$"), SV("{:$^12.6L}"), F(-1.234567e3L));
  test(SV("-0001,234.57"), SV("{:012.6L}"), F(-1.234567e3L));

  std::locale::global(loc);
  test(SV("1_23_4#57$$$"), SV("{:$<12.6L}"), F(1.234567e3L));
  test(SV("$$$1_23_4#57"), SV("{:$>12.6L}"), F(1.234567e3L));
  test(SV("$1_23_4#57$$"), SV("{:$^12.6L}"), F(1.234567e3L));
  test(SV("0001_23_4#57"), SV("{:012.6L}"), F(1.234567e3L));
  test(SV("-1_23_4#57$$$"), SV("{:$<13.6L}"), F(-1.234567e3L));
  test(SV("$$$-1_23_4#57"), SV("{:$>13.6L}"), F(-1.234567e3L));
  test(SV("$-1_23_4#57$$"), SV("{:$^13.6L}"), F(-1.234567e3L));
  test(SV("-0001_23_4#57"), SV("{:013.6L}"), F(-1.234567e3L));

  test(SV("1,234.57$$$"), en_US, SV("{:$<11.6L}"), F(1.234567e3L));
  test(SV("$$$1,234.57"), en_US, SV("{:$>11.6L}"), F(1.234567e3L));
  test(SV("$1,234.57$$"), en_US, SV("{:$^11.6L}"), F(1.234567e3L));
  test(SV("0001,234.57"), en_US, SV("{:011.6L}"), F(1.234567e3L));
  test(SV("-1,234.57$$$"), en_US, SV("{:$<12.6L}"), F(-1.234567e3L));
  test(SV("$$$-1,234.57"), en_US, SV("{:$>12.6L}"), F(-1.234567e3L));
  test(SV("$-1,234.57$$"), en_US, SV("{:$^12.6L}"), F(-1.234567e3L));
  test(SV("-0001,234.57"), en_US, SV("{:012.6L}"), F(-1.234567e3L));

  std::locale::global(en_US);
  test(SV("1_23_4#57$$$"), loc, SV("{:$<12.6L}"), F(1.234567e3L));
  test(SV("$$$1_23_4#57"), loc, SV("{:$>12.6L}"), F(1.234567e3L));
  test(SV("$1_23_4#57$$"), loc, SV("{:$^12.6L}"), F(1.234567e3L));
  test(SV("0001_23_4#57"), loc, SV("{:012.6L}"), F(1.234567e3L));
  test(SV("-1_23_4#57$$$"), loc, SV("{:$<13.6L}"), F(-1.234567e3L));
  test(SV("$$$-1_23_4#57"), loc, SV("{:$>13.6L}"), F(-1.234567e3L));
  test(SV("$-1_23_4#57$$"), loc, SV("{:$^13.6L}"), F(-1.234567e3L));
  test(SV("-0001_23_4#57"), loc, SV("{:013.6L}"), F(-1.234567e3L));
}
